...
export const GwLink = ({ id, children }) => id != null && id !== '' ? <a className="lk-link mono" onClick={stop(() => go('#/gateways', { sel: id }))} title="게이트웨이 목록에서 보기">{children ?? `GW ${id}`}</a> : <span className="muted">—</span>
